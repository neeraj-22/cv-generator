      ...
      <Form className="form-section">
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel>First Name<sup style={{color:"red"}}>*</sup> </FormLabel>
            <FormControl
              type="text"
          ...
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel>Last Name <sup style={{color:"red"}}>*</sup></FormLabel>
            <FormControl
              type="text"
          ...
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel>Gender <sup style={{color:"red"}}>*</sup></FormLabel>
            <FormControl
              as="select"
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel>Age <sup style={{color:"red"}}>*</sup></FormLabel>
            <FormControl
              type="number"
              min="1"
          ...
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel>Location <sup style={{color:"red"}}>*</sup></FormLabel>
            <FormControl
              type="text"
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12} md={4}>
            <FormLabel> Mobile Phone <sup style={{color:"red"}}>*</sup></FormLabel>
            <FormControl
              type="number"
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12}>
            <Form.Label>Describe Yourself <sup style={{color:"red"}}>*</sup></Form.Label>
            <Form.Control
              as="textarea"
              rows={4}
        ...
        <h1 className="text-dark font-weight-bold py-4">
          Educational Detail (Add 2 educational details) <sup style={{color:"red"}}>*</sup>
        </h1>
        <Form.Row>
          <FormGroup as={Col} sm={12} md={6}>
            <FormLabel> HSC CGPA </FormLabel>
            <FormControl
              type="text"
              placeholder="Your 12th grade cgpa"
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12} md={6}>
            <FormLabel> Masters degree </FormLabel>
            <FormControl
              type="text"
        ...
        <Form.Row>
          <FormGroup as={Col} sm={12}>
            ...
            <Form.Control
              as="textarea"
              rows={3}
              placeholder="Blockchain, WEB3, MERN.."
